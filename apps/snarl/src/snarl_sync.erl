...
sync_op(Node, VNode, System, User, Op, Val) ->
    gen_server:cast(?SERVER, {write, Node, VNode, System, User, Op, Val}).
...
%% @end
%%--------------------------------------------------------------------
handle_cast({write, Node, VNode, System, User, Op, Val}, State = #state{host=undefined}) ->
